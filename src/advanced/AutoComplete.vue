...
<template>
  <div
    ...
    :class="[
      ...
      {
        'ui-auto-complete--open': showDropdown,
        'ui-auto-complete--disabled': disabled,
        'ui-auto-complete--block': block
      }
    ]"
  >
    <div class="ui-auto-complete__input-box">
      <slot name="prefix">
        <span v-if="prefixIcon" class="material-symbols-outlined ui-auto-complete__prefix">
          {{ prefixIcon }}
        </span>
      </slot>
      ...
      <input
        ...
        :disabled="disabled"
        class="ui-auto-complete__native"
        @input="handleInput"
        @focus="handleFocus"
        @blur="handleBlur"
      ...
      <slot name="suffix">
        <span v-if="suffixIcon" class="material-symbols-outlined ui-auto-complete__suffix">
          {{ suffixIcon }}
        </span>
      </slot>
    ...
    <!-- Suggestions Popover -->
    <transition name="ui-auto-complete-fade">
      <div v-if="showDropdown" class="ui-auto-complete__dropdown" @click.stop>
        <div
          v-for="(opt, idx) in filteredOptions"
          :key="opt.value"
          :class="[
            'ui-auto-complete__item',
            {
...
.ui-auto-complete-fade-enter-active,
.ui-auto-complete-fade-leave-active {
  transition: opacity 0.18s var(--ease-soft), transform 0.18s var(--ease-out);
}
.ui-auto-complete-fade-enter-from,
.ui-auto-complete-fade-leave-to {
  opacity: 0;
